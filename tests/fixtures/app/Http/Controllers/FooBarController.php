...
class FooBarController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return response()->view('foo-bars.index', compact('fooBars'));
    }
    ...
    public function create()
    {
        ...
        return response()->view('foo-bars.create', compact('fooBar'));
    }
    ...
    public function edit($id)
    {
        ...
        return response()->view('foo-bars.edit', compact('fooBar'));
    }
